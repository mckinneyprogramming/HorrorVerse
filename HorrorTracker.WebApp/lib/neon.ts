...
export async function requireSessionUser(request: Request, connectionString: string): Promise<SessionUser> {
...
export function jsonError(
  error: unknown,
  options: { log: string; fallback: string; unavailable?: string },
): Response {
